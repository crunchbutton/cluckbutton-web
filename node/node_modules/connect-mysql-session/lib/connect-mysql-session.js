...
module.exports = function (connect)
{
    function MySQLStore(options)
    {
        ...
        var sequelize = options.sequelize || new Sequelize(options.database, options.user, options.password, options.options);
        
        var Session = options.session || sequelize.define('Session', {
